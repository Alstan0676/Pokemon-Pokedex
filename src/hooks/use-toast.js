...
// Store for toasts with listeners for state updates
...
export const reducer = (state, action) => {
  switch (action.type) {
    ...
    case "DISMISS_TOAST": {
      ...
      // Side effects - Add toast(s) to remove queue
      if (toastId) {
...
/**
 * Dispatches actions to the toast reducer and notifies listeners
